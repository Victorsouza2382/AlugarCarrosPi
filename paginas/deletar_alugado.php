...
<div class="panel panel-default">
	<div class="panel-body">
		<h4 class="mb-5" style="text-align: center">Deletar Alugado</h4>

		
        <div class="row justify-content-center">
            <div class="form-group">
                <form action="php/processamento.php?acao=deletarAlugado" method="post" class="border p-5 border-dark rounded shadow" enctype="multipart/form-data">
